        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            >
              ...
              >
                <Link href="/quizzes/public" className="block px-4 py-2 text-gray-300 hover:text-white hover:bg-slate-700 transition-colors text-sm">
                  Public Quiz
                </Link>
                <Link href="/quizzes/pin" className="block px-4 py-2 text-gray-300 hover:text-white hover:bg-slate-700 transition-colors text-sm">
                  Pin Quizzes
                </Link>
