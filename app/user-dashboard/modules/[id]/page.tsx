...
export default function ModuleDetail() {
  ...
  if (!session) {
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-gray-300 text-lg">Please sign in to view this module.</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-full sm:max-w-3xl md:max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        {/* Status Badge */}
        ...
        {/* Title */}
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-100 mb-6 sm:mb-8 leading-tight">
          {module.title}
        </h1>
        ...
        {/* Message Alert */}
        {message && (
          <div className={`mb-6 sm:mb-8 p-3 sm:p-4 rounded-lg border-l-4 ${
        ...
        {/* Module Description */}
        <div className="mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-100 mb-3 sm:mb-4">Module Overview</h2>
        ...
        {/* Main Content */}
        <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
          <div className="prose prose-sm sm:prose-base max-w-none text-gray-300 leading-relaxed">
        ...
        {/* Completion Section */}
        <div className="bg-gradient-to-r from-cyan-900 to-blue-900 rounded-xl p-4 sm:p-6 md:p-8 border border-cyan-700">
          <div className="text-center">  
            <Button
              onClick={handleComplete}
              disabled={isCompleted || isLoading}
              className={`px-6 sm:px-8 py-2 sm:py-3 text-base sm:text-lg font-medium rounded-lg transition-all duration-200 ${
                isCompleted || isLoading
                  ? 'bg-gray-600 text-gray-400 cursor-not-allowed'
                  : 'bg-cyan-600 hover:bg-cyan-700 text-white shadow-lg hover:shadow-xl transform hover:-translate-y-0.5'
              }`}
            >
              {isLoading ? (
